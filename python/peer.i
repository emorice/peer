...
%apply (float64_t* IN_FARRAY2, int32_t DIM1, int32_t DIM2) {(float64_t* matrix, int32_t rows, int32_t cols)};


// typemap for return matrix arguments
%apply (float64_t** ARGOUTVIEWM_FARRAY2, int32_t* DIM1, int32_t* DIM2) {(float64_t** matrix, int32_t* rows, int32_t* cols)};
